insert into groupomania_schema.users (id, username, password, password_change_required) values
...
insert into groupomania_schema.campaign (id, title, description, type, state, start_date, end_date, show_after_expiration, quantity, original_price, percent_discount) values
...
insert into groupomania_schema.authority(id, authority) values
